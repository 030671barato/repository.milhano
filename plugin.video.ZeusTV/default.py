...
def SKindex():
    addon_log("SKindex")
    addDir('Favoritos','Favoritos',4,'https://cld.pt/dl/download/17d24311-1dfe-4ad8-97f2-aab3a3f6313e/Favoritos.jpg' ,  FANART,'https://cld.pt/dl/download/17d24311-1dfe-4ad8-97f2-aab3a3f6313e/Favoritos.jpg','','','')
...
def getSources():
        if os.path.exists(Favoritos) == True:
            addDir('Favoritos','url',4,os.path.join(home, 'resources', 'favorite.png'),FANART,'https://cld.pt/dl/download/17d24311-1dfe-4ad8-97f2-aab3a3f6313e/Favoritos.jpg','','','')

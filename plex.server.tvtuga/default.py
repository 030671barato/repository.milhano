...
puerto = 'aHR0cDovL21pbGhhbm8ucHcvcGxleC50dnR1Z2EvbWFpbi50eHQ='.decode('base64')
...
addon = xbmcaddon.Addon('plex.server.tvtuga-0.1')
...
def makeRequest(url, headers=None):
        try:
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(tvtuga,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(tvtuga,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")

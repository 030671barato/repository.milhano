...
# 																			   #
# Traduzido por:															   #
# Joao Milhano Fernandes     												   #
# Contato: j2mf4@hotmail.com						    					   #
#                                											   #
################################################################################
...
MYBUILDS         = os.path.join(BACKUPLOCATION, 'Backup_Milhano', '')
		...
		if len(match) >= 1:
			if SEPERATE == 'true':
				...
				if count18 > 0 and KODIVERSION.startswith("18"):
					...
					addFile('[B]%s Milhano para Kodi Leia Beta 18(%s)[/B]' % (state, count18), 'togglesetting',  'show17', themeit=THEME3)
					if SHOW18 == 'true':
						for name, version, url, gui, kodi, theme, icon, fanart, adult, description in match:
							if not SHOWADULT == 'true' and adult.lower() == 'yes': continue
							if not DEVELOPER == 'true' and wiz.strTest(name): continue
				...
				if count15 > 0 and KODIVERSION.startswith("15"):
					...
					addFile('[B]%s Milhano para Kodi Isengard(%s)[/B]' % (state, count15), 'togglesetting',  'show15', themeit=THEME3)
					if SHOW15 == 'true':
						for name, version, url, gui, kodi, theme, icon, fanart, adult, description in match:
							if not SHOWADULT == 'true' and adult.lower() == 'yes': continue
							if not DEVELOPER == 'true' and wiz.strTest(name): continue
				...
				if count16 > 0 and KODIVERSION.startswith("16"):
					...
					addFile('[B]%s Milhano para Kodi Jarvis 16(%s)[/B]' % (state, count16), 'togglesetting',  'show16', themeit=THEME3)
					if SHOW16 == 'true':
						for name, version, url, gui, kodi, theme, icon, fanart, adult, description in match:
							if not SHOWADULT == 'true' and adult.lower() == 'yes': continue
							if not DEVELOPER == 'true' and wiz.strTest(name): continue
				...
				if count17 > 0 and KODIVERSION.startswith("17"):
					...
					addFile('[B]%s Milhano para Kodi Krypton 17(%s)[/B]' % (state, count17), 'togglesetting',  'show17', themeit=THEME3)
					if SHOW17 == 'true':
						for name, version, url, gui, kodi, theme, icon, fanart, adult, description in match:
							if not SHOWADULT == 'true' and adult.lower() == 'yes': continue
							if not DEVELOPER == 'true' and wiz.strTest(name): continue

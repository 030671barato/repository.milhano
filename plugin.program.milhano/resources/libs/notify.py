...
def firstRun():
	class MyWindow(xbmcgui.WindowXMLDialog):
		def __init__(self, *args, **kwargs):
			...
			self.msg   = "Atualmente voce nao possui nenhuma Build Instalada usando o %s.\n\nPara instalar, proceda da seguinte maneira: selecione 'IGNORAR', va em ADDONS-->PROGRAM ADD-ONS e execute o assistente MILHANO WIZARD, e siga as instrucoes para instalar uma versao da %s\n\nObrigado por utilizar o %s." % (ADDONTITLE,BUILDERNAME, ADDONTITLE)

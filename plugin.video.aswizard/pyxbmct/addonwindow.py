...
_images = os.path.join(Addon('plugin.video.aswizard').getAddonInfo('path'),'pyxbmct', 'textures', 'default')
#_images = os.getcwd()+'/addons/plugin.video.aswizard/pyxbmct/textures/default'
